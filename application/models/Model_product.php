...
class Model_product extends CI_model{
    function kategori_berita(){
        return $this->db->query("SELECT * FROM kategori_product ORDER BY id_kategori DESC");
    }
    ...
    function kategori_berita_tambah(){
        ...
        $this->db->insert('kategori_product',$datadb);
    }

    function kategori_berita_edit($id){
        return $this->db->query("SELECT * FROM kategori_product where id_kategori='$id'");
    }
    ...
    function kategori_berita_update(){
        ...
        $this->db->update('kategori_product',$datadb);
    }

    function kategori_berita_delete($id){
        return $this->db->query("DELETE FROM kategori_product where id_kategori='$id'");
    }
    ...
    function list_berita_rss(){
        return $this->db->query("SELECT a.*, b.nama_kategori FROM berita a LEFT JOIN kategori_product b ON a.id_kategori=b.id_kategori ORDER BY a.id_berita DESC LIMIT 10");
    }

    function list_berita(){
        return $this->db->query("SELECT a.*, b.nama_kategori FROM berita a LEFT JOIN kategori_product b ON a.id_kategori=b.id_kategori ORDER BY a.id_berita DESC");
    }
