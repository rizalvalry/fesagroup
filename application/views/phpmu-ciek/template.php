...
<html lang="en-US">
    ...
    <head>
          ...
          <meta name="author" content="Rizal Valry">
                ...
                <div class="container">
                    <div class="page-title-inner">
                        <ul class="cms-breadcrumb">
                            <li><a class="breadcrumb-entry" href="<?= base_url(); ?>">Home</a></li>
                            <li><span class="breadcrumb-entry"><?php echo $this->uri->segment(1); ?></span></li>
                        </ul>
                        <h1 class="page-title ft-heading-b"><?php echo $this->uri->segment(1); ?></h1>
                    </div>
                </div>
            </div>
