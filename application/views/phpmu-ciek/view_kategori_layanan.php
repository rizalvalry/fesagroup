                                                            ...
                                                            <div class="cms-grid-inner cms-grid-masonry row animation-time" data-gutter="15">
                                                                ...
                                                                <div class="grid-item col-lg-4 col-md-6 col-sm-12 col-12 " style="margin-bottom: 5em !important;">
                                                                    <div class="grid-item-inner wpb_animate_when_almost_visible wpb_fadeIn fadeIn">
                                                                        <a href="<?= base_url(); ?>layanan/detail/<?= $row['judul_seo']; ?>">
                                                                            <div class="item-featured">
                                                                                <div class="item-background bg-image" style="background: url('<?= base_url(); ?>asset/foto_layanan/<?= $foto; ?>')"></div>
                                                                            </div>
                                                                        </a>
                                                                        <div class="item-holder">
                                                                            ...
                                                                            <h3 class="item-title"> <a href="<?= base_url(); ?>layanan/detail/<?= $row['judul_seo']; ?>"><?= $row['judul']; ?></a></h3>
                                                                              <div class="item-content">
                                                                                    <?= $isi; ?>
                                                                              </div>
                                                                            <div class="item-readmore"> <a href="<?= base_url(); ?>layanan/detail/<?= $row['judul_seo']; ?>">Read More</a></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <?php $no++; 
