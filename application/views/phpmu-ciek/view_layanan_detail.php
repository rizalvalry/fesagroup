                            ...
                            <main id="main" class="site-main">
                                <article id="post-185" class="single-hentry post-185 post type-post status-publish format-standard has-post-thumbnail hentry category-industry category-news tag-business tag-corporate tag-modern tag-responsive">
                                    <div class="entry-featured">
                                        <div class="post-image"> <img width="1024" height="683" src="<?= base_url(); ?>asset/foto_layanan/<?= $record['gambar']; ?>" class="attachment-full size-full wp-post-image" alt="" decoding="async" srcset=" <?= base_url(); ?>asset/foto_layanan/<?= $record['gambar']; ?> 1024w, <?= base_url(); ?>asset/foto_layanan/<?= $record['gambar']; ?> 768w"
                                    ...
                                    <div class="entry-hoder">
                                        <div class="post-meta">
                                            <div class="meta-categories"> 
                                              ...
                                              <a href="<?= base_url(); ?>layanan/kategori/<?= $record['kategori_seo']; ?>" rel="category tag"><?= $record['nama_kategori']; ?></a> 
