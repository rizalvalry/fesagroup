<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/tambah_kategorilayanan',$attributes); 
          echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url().$this->uri->segment(1)."/kategorilayanan'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
