  ...
  .sekolah:hover{
    color:#fff;
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-lg"><b>FESA GROUP</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown messages-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="label label-success"><?php echo $this->model_hubungi->pesan_masuk()->num_rows(); ?></span>
                </a>
                <ul class="dropdown-menu">
                  <li class="header">You have <?php echo $this->model_hubungi->pesan_masuk()->num_rows(); ?> new messages</li>
                  <li>
                    <ul class="menu">
                      <?php 
