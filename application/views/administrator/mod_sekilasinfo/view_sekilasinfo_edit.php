    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Isi</th>              <td><textarea id='editor1' class='form-control' name='e' style='height:120px'>$rows[isi]</textarea></td></tr>
                    <tr><th scope='row'>Ganti Gambar</th>                    <td><input type='file' class='form-control' name='b'><hr style='margin:5px'>
                    <tr><th scope='row'>Aktif</th>               <td>"; if ($rows['aktif']=='Y'){ echo "<input type='radio' name='c' value='Y' checked> Y &nbsp; <input type='radio' name='c' value='N'> N"; }else{ echo "<input type='radio' name='c' value='Y'> Y &nbsp; <input type='radio' name='c' value='N' checked> N"; } echo "</td></tr>
                    <tr><th width='50px' scope='row'>Urutan</th>   <td><input type='number' class='form-control' name='d' value='$rows[urutan]'></td></tr>";
